...
pub const cdefs = struct {
    ...
    pub extern fn Clay_GetScrollOffset() Vector2; // TODO: add user facing function
    ...
    pub extern fn Clay_GetPointerOverIds() ClayArray(ElementId); // TODO: add user facing function
